...
```typescript
// Creating a dataset invalidates dataset list
useCreateDataset() → invalidates ['datasets']

// Updating a dataset invalidates that dataset
useUpdateDataset() → invalidates ['dataset', id]

// Deleting invalidates both
useDeleteDataset() → invalidates ['dataset', id] and ['datasets']
```
