...
Reference documentation for external technologies, APIs, standards, and frameworks that dkanClientTools integrates with.

---

## Purpose

This directory provides context about third-party systems and technologies:

- **DKAN Platform** - Data catalog platform and REST APIs
- **TanStack Query** - Data fetching and caching library
- **Data Standards** - DCAT-US and Frictionless specifications
- **Framework References** - TypeScript, React, and Vue patterns
...
**For Developers**: Reference these guides to understand the external technologies dkanClientTools builds upon.

**For AI Agents**: Use these documents to understand external APIs, frameworks, and standards when assisting with development.
